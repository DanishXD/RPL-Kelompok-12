...
export default function SettingsScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScreenHeader
        title="Setelan"
        subtitle="Akun, Perangkat & Preferensi"
        showBack
      />
      <ScrollView
      ...
      >
        ...
        <View style={styles.group}>
          <Row
            ...
            subtitle="Nama, email, preferensi"
        ...
        <View style={styles.group}>
          ...
          >
            <View style={styles.setupDeviceBtnLeft}>
              ...
              <View>
                <Text style={styles.setupDeviceBtnTitle}>
                  Manajemen Perangkat
                </Text>
          ...
          <Row
            ...
            subtitle="Terakhir sync: hari ini"
            onPress={() => {
              loadDeviceInfo();
        ...
        <View style={styles.group}>
          <View style={styles.helpRow}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
              onPress={() =>
                Alert.alert("Manual", "Dokumentasi akan segera tersedia")
              }
            >
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                Alert.alert(
                  "Support",
                  "Email: danishafidwibisono@apps.ipb.ac.id",
                )
              }
            >
              <Text style={styles.helpIcon}>📞</Text>
        ...
        <Text style={styles.version}>EcoSmart Feeder v1.0.0</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
