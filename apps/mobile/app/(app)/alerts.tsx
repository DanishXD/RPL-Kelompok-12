...
export default function AlertsScreen() {
  ...
  const handleSave = async () => {
    ...
    Alert.alert(
      "✅ Tersimpan",
      "Threshold berhasil disimpan. Alert akan menggunakan nilai baru ini.",
    );
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScreenHeader
        ...
        subtitle={`${alerts.length} alert aktif saat ini`}
        showBack
        rightElement={
          alerts.length > 0 ? (
            <View style={styles.activeBadge}>
              <Text style={styles.activeBadgeText}>{alerts.length} Aktif</Text>
            </View>
          ) : undefined
        }
      />
        ...
        {alerts.map((alert, i) => {
          ...
          return (
            <View
              ...
              style={[
                styles.alertCard,
                isCritical ? styles.alertDanger : styles.alertWarning,
              ]}
            >
